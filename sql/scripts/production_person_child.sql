...
CREATE TABLE `person_child` (
  `child_relation_id` varchar(50) NOT NULL,
  `from_id` varchar(50) DEFAULT NULL,
  `to_id` varchar(50) DEFAULT NULL,
  `is_parent` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`child_relation_id`),
  UNIQUE KEY `person_child_id_UNIQUE` (`child_relation_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Relation table between person and child';
...
INSERT INTO `person_child` VALUES ('12f524a9-8585-4b60-cade-d39fbe421d0e','23.45.56','12f524a9-8585-4a80-bbbe-d39fbe421d0e',1),('12f604a9-8585-4b60-cade-d39fbe421d0e','23.45.56','12f524a9-8585-4b60-bbbe-d39fbe421d0e',1);
